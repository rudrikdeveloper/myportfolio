...
export function ThreeDCard() {
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-light relative group/card dark:bg-dark border-black/[0.1] w-auto h-auto rounded-xl dark:border-light flex justify-center items-center">
